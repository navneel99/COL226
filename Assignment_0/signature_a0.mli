...
#2 Your code won't compile if all the functions declared in the signature_a0.ml are not implemented in the structure_a0.ml. In case you decide not to implement a function, but want
your code to compile and run.
 - Mention this in the comments
 - Add "exception Not_implemented" in the structure_a0
...
#3 Run your code in the top level as (Assume the signature_a0.ml file is in the same folder)
  #use "structure_a0.ml";;
  open A0;;
